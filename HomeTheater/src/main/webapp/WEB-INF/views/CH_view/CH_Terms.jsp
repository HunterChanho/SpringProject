...
<link rel="stylesheet" href="css/CH_css/CH_Terms.css">
<title>이용약관</title>
</head>
<body>
<div class="container">
 <div class="content">
	...
	<form name="agreement" class="form-horizontal" action="<%=context%>/joinMember" method="get" > 
		<div class="container">
			<div class="agree_form">
				<input type="checkbox" name="check" onclick="selectAll(this)">
				<label>이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), 프로모션 정보 수신(선택)에 모두 동의합니다. [전체동의]</label><hr>
				
				<input type="checkbox" name="check2" 
					   required oninvalid="this.setCustomValidity('필수항목입니다!')"
			  		   oninput = "setCustomValidity('')"/>
				<label>HomeTheater 이용약관 동의 [필수]</label><br>	
...
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 HomeTheater 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, HomeTheater는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
				...
				<label>위치정보 이용약관 동의 [선택]</label><br>
				<div class="text-center">
				<textarea style="resize: none;" rows="5" cols="120" readonly>	
...
이 약관은 HomeTheater 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
				...
				<label>프로모션 정보 수신 동의 [선택]</label><br>
				<label id="last" style="width: 700px; height: 100px; display: inline-block;">
HomeTheater에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(HomeTheater앱 알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스>(별도 회원체계로 운영하거나 HomeTheater 가입 이후 추가 가입하여 이용하는 서비스 등)의 경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로안내하고 동의를 받습니다.
				...
				<div class="text-center">
					...
					<input class="btn" type="submit" value="확인" style="font-weight: bold;"><br><br>
				</div>
			</div>	
		</div>
	</form>
